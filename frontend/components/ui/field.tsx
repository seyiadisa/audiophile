...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "text-body text-primary mb-4 text-[13px] font-bold tracking-[0.93px] uppercase",
        className
      )}
      {...props}
    />
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 text-sm leading-snug font-bold tracking-[-0.25px] group-data-[disabled=true]/field:opacity-50",
        className
      )}
      {...props}
    />
